import {AuthenticatedCheck} from "./authenticatedCheck.ts";
import {PasswordMatchCheck} from "./passwordMacthCheck.ts";
import {PostExistsCheck} from "./postExistsCheck.ts";
